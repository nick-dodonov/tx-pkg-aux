...
namespace Rtt::Rtc
{
    ...
    public:
        ...
        void Send(const PeerId& to, std::string payload) override { JsWsContext_Send(_ctx, to.value.c_str(), payload.c_str()); }
    ...
    extern "C" {
        ...
        EMSCRIPTEN_KEEPALIVE void JsWsContext_OnMessage(JsWsSigContext* ctx, const char* fromId, const char* payload)
        {
